...
const char *ssid     = "nome";  //atribuir nome da rede WiFi
        ...
        {                                      //sim           
          ...
          if (currentLine.length() == 0)       //se final da mensagem...
          {
            ...
            if(RL1_status=="OFF") {
              ...
              client.println("<input type=\"datetime\" id=\"hora\" name=\"hora\"  value =\"ONhoraRL1\" placeholder=\"hh:mm:ss\">"); // liga
              client.println("<input type=\"datetime\" id=\"hora\" name=\"hora\"  value =\"OFFhoraRL1\" placeholder=\"hh:mm:ss\">"); // desliga
            }
            else {
              ...
              client.println("<input type=\"datetime\" id=\"hora\" name=\"hora\" value =\"ONhoraRL1\" placeholder=\"hh:mm:ss\">");
              client.println("<input type=\"datetime\" id=\"hora\" name=\"hora\"  value =\"OFFhoraRL1\" placeholder=\"hh:mm:ss\">");
            }
          ...
          client.println("<li>");
            ...
            if(RL2_status=="OFF"){
              ...
              client.println("<input type=\"datetime\" id=\"hora\" name=\"hora\" value =\"ONhoraRL2\" placeholder=\"hh:mm:ss\">");
              client.println("<input type=\"datetime\" id=\"hora\" name=\"hora\" value =\"OFFhoraRL2\" placeholder=\"hh:mm:ss\">");
            }
            else {
            ...
            if(RL3_status=="OFF"){
              ...
              client.println("<input type=\"datetime\" id=\"hora\" name=\"hora\"  value =\" ONhoraRL3\" placeholder=\"hh:mm:ss\">");
              client.println("<input type=\"datetime\" id=\"hora\" name=\"hora\"  value =\"ONhoraRL3\" placeholder=\"hh:mm:ss\">");
            }
            else {
            ...
            if(RL4_status=="OFF"){
              ...
              client.println("<input type=\"datetime\" id=\"hora\" name=\"hora\"  value =\"ONhoraRL4\" placeholder=\"hh:mm:ss\">");
              client.println("<input type=\"datetime\" id=\"hora\" name=\"hora\"  value =\"ONhoraRL4\" placeholder=\"hh:mm:ss\">");
            }
            else {
